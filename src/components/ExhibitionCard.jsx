    ...
    return (
        <swiper-slide>
            ...
            <div className="w-2/4 max-[991px]:w-full h-full text-start flex flex-col justify-center px-5 bg-[#303030] shadow-inner max-[991px]:pt-5">
                ...
                <div className="py-6">
                    <Link to="/exh/medieval" className="text-[14px] text-yellow-600 font-sans font-semibold border-2 border-yellow-600 px-4 py-2 hover:bg-yellow-500 hover:text-black duration-300 ease">
                        See More
                    </Link>
                </div>
            </div>
