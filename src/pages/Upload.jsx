...
const Upload = () => {
    ...
    return (
        <div className="w-xl mx-auto m-20 p-8 bg-neutral-800 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-white text-center mb-6">Upload Your Artwork</h2>
            <p className="text-sm text-gray-300 text-center mb-6">Art is not what you see, but what you make others see. - Edgar Degas</p>
