            ...
            <div className="w-xl h-2/12 p-10 bg-neutral-800 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="md:gap-5 grid max-md:grid-cols-1 grid-cols-2">
                    <div className='max-md:col-span-2'>
                        ...
                        <input type="text" required className="mt-2 block w-full p-2 bg-neutral-600 text-white rounded-md focus:outline-none focus:border-yellow-500 placeholder:italic placeholder:text-neutral-400" placeholder="What would you like this artwork to be known as?" />
                    </div>
                    <div className='max-md:col-span-2'>
                        <label className="block text-sm font-medium text-gray-300">Author</label>
                        <input type="text" required className="mt-2 block w-full p-2 bg-neutral-600 text-white rounded-md focus:outline-none focus:border-yellow-500 placeholder:italic placeholder:text-neutral-400" placeholder="Who is the creative mind behind this piece?" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-300">Date Released</label>
                        <input type="text" required className="mt-2 block w-full p-2 bg-neutral-600 text-white rounded-md focus:outline-none focus:border-yellow-500 placeholder:italic placeholder:text-neutral-400" placeholder="When was this masterpiece unveiled?" />
                    </div>
                    <div className='max-md:col-span-2'>
                        <label className="block text-sm font-medium text-gray-300">Classification</label>
                        <input type="text" required className="mt-2 block w-full p-2 bg-neutral-600 text-white rounded-md focus:outline-none focus:border-yellow-500 placeholder:italic placeholder:text-neutral-400" placeholder="How would you categorize this work?" />
                    </div>
                    <div className='max-md:col-span-2'>
                    ...
                    <div className='md:col-span-2'>
                        ...
                        <textarea required className="mt-2 block w-full p-2 bg-neutral-600 text-white rounded-md focus:outline-none focus:border-yellow-500 placeholder:italic placeholder:text-neutral-400" placeholder="Tell us the story behind this creation. What inspired it?"></textarea>
                    </div>
